...
/*
** Setup monitor thread parameters
*/
...
/*
** Handle the case when all philosophers have eaten enough
*/
...
int	check_all_ate_enough(t_data *data)
{
	...
	// Check if all philosophers have eaten enough
	all_ate_enough = check_philosophers_meals(data);
